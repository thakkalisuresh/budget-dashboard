 ...
 * Handles webhook validation, file downloads, and Telegram-specific I/O.
...
import { validateMagicBytes, ALLOWED_MEDIA_TYPES } from './_whatsapp.mjs';
import {
  handleTextReply,
  handleMediaMessage,
  handleAttachMedia,
...
export default async function handler(req) {
  ...
  if (update.callback_query) {
    ...
    if (!isAllowedUser(userId, ALLOWED_USERS)) {
