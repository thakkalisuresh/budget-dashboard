...
//
// ⚠️  MIRROR of src/splitNotes.js — the Telegram bot writes the same notes the
// dashboard reads, so the caps and formatting must match exactly. Keep the two
// byte-identical below this header; splitNotesSync.test.js guards it.
//
