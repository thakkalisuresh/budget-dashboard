 ...
 *
 * ⚠️  MIRROR: this file is duplicated at src/itemCategorizer.js for the web
 * "Scan Receipt" path (the frontend can't import from the functions package).
 * Keep the two byte-identical except for the export style. itemCategorizerSync
 * test guards the keyword tables.
 *
